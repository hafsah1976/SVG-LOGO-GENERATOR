  ...
  render() {
    ...
    return `
      <svg version="1.1" 
          ...
          <text x="100" y="185" font-size="45" font-family="Arial, sans-serif" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
      </svg>
    `;
  }
}
  ...
  render() {
    ...
    return `
      <svg version="1.1" 
          width="300" height="200"
          xmlns="http://www.w3.org/2000/svg">
          <rect x="50" y="50" fill="${this.shapeColor}"/>
          <text x="100" y="185" font-size="45" font-family="Arial, sans-serif" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
      </svg>
    `;
  }
  ...
  render() {
    ...
    return `
      <svg version="1.1" 
          width="300" height="200"
          xmlns="http://www.w3.org/2000/svg">
          <rect x="50" y="50" rx="30" ry="30" fill="${this.shapeColor}"/>
          <text x="100" y="185" font-size="45" font-family="Arial, sans-serif" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
      </svg>
    `;
  }
